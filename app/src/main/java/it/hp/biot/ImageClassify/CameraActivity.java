...
public abstract class CameraActivity extends AppCompatActivity
    ...
    protected void onCreate(final Bundle savedInstanceState) {
      ...
      /*  Toolbar toolbar = findViewById(R.id.toolbar);
        ...
        //Henry add: Return back the Main activity
        Button btnCameraBack = (Button) findViewById(R.id.btnCameraBack);
        btnCameraBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentBack = new Intent(CameraActivity.this, MainActivity.class);
                //Add result back
                intentBack.putExtra("strResulIntent", recognitionTextView.getText());
