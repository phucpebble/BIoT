...
public class QrGenerate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get name of scanned food with time and display on the textbox
        /*Intent intent = getIntent();
        Log.d("AAA", "Value get from Intent FoodName_TimeScan is " + intent.getStringExtra("FoodName_TimeScan"));
        qrInput.setText(intent.getStringExtra("FoodName_TimeScan"));*/

        SmartContract smartContract = new SmartContract();
        Log.d("AAA", "Address of smart contract is " + smartContract.getContractAddress());
        qrInput.setText(smartContract.getContractAddress());
